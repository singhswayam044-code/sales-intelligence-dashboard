-- ============================================
-- GOLD LAYER: Monthly Revenue KPIs — UPDATED
-- Now split by order_status for Finance team
-- Change requested: Q1 forecast visibility
-- ============================================
...
SELECT
  ...
  order_status,                                      -- NEW: added status column
...
-- REMOVED: AND order_status = 'delivered'
-- All statuses now included so Finance sees full pipeline
